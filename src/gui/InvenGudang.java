...
public class InvenGudang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbJangka = new javax.swing.JComboBox<>();
        ...
        tfPemilik.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfPemilikActionPerformed(evt);
            }
        });

        cmbJangka.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1 Tahun", "2 Tahun", "3 Tahun" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(cmbJangka, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel6)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmbJangka, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    String pemilik = tfPemilik.getText();
    String telepon = tfTelepon.getText();
    String relasi = cmbJangka.getSelectedItem().toString();

    // Validasi input kosong
    if (nama.isEmpty() || kode.isEmpty() || pemilik.isEmpty() || telepon.isEmpty()) {
    ...
    model.addRow(new Object[]{nama, kode, pemilik, telepon, relasi});
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        // Ambil nilai dari input fields
        String nama = tfNama.getText();
        String telepon = tfKode.getText();
        String email = tfPemilik.getText();
        String alamat = tfTelepon.getText();
        String relasi = cmbJangka.getSelectedItem().toString();
    ...
    private void tblKontakMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblKontakMouseClicked
        ...
        if (selectedRow != -1) {
            ...
            tfKode.setText(model.getValueAt(selectedRow, 1).toString());
            tfPemilik.setText(model.getValueAt(selectedRow, 2).toString());
            tfTelepon.setText(model.getValueAt(selectedRow, 3).toString());
            cmbJangka.setSelectedItem(model.getValueAt(selectedRow, 4).toString());
    ...
    private void tfKodeKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfKodeKeyTyped
    ...
    }//GEN-LAST:event_tfKodeKeyTyped

    private void tfPemilikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfPemilikActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfPemilikActionPerformed
    ...
    private javax.swing.JComboBox<String> cmbJangka;
